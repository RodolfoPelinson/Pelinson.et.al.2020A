...
```{r Dif_dist Third, cache=TRUE, warning=FALSE, message=FALSE}
set.seed(1)
...
```{r Dif_dist_1000_times, cache=TRUE, message=FALSE, warning=FALSE}
#Excluding samples for balanced design
set.seed(1)
...
In 95% of the cases the difference between fish and fishless ponds was greater in the 480m distance, if compared to the 30m distance. Also, this difference was significantly greater in isolated ponds in 64% of these cases.
