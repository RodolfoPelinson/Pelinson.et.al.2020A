...
Plotting coefficients and confidence intervals for each predators and herbivores
```{r}
...
### First Survey
```{r Dif_dist First Survey, cache=F}
...
### Second Survey
```{r Dif_dist Second Survey, cache=F}
#Excluding samples for balanced design
set.seed(3)
...
```{r Dif_dist Third Survey, cache=F}
#Excluding samples for balanced design
set.seed(1)
